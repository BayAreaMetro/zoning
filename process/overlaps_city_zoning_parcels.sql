...
(select zoning.get_id(zoning,juris) as 
	zoning_id, zoning, juris, tablename, geom 
	from zoning.cities_towns_valid) as z
...
DROP INDEX IF EXISTS zoning_parcel_overlaps_cities_zoning_id_idx;
