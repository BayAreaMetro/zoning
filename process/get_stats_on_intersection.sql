...
COMMENT ON TABLE zoning.parcel_intersection_count is 'count by geom_id of st_intersects of parcel and zoning with geometry';
...
COMMENT ON VIEW zoning.parcel_intersection_count is 'parcels that have more than 1 intersecting zoning multipolygon';
