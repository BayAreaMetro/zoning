...
=======
\COPY zoning.codes_dictionary FROM 'data_source/zoning_codes_base2008.csv' WITH (FORMAT csv, DELIMITER ',', HEADER TRUE);
>>>>>>> add-plu-data
...
CREATE TABLE zoning.codes_dictionary_plu (
	id integer,
	juris integer, 
	city text, 
	lpscode int,
...
\COPY zoning.codes_dictionary_plu FROM 'data_source/zoning_codes_base2008.csv' WITH (FORMAT csv, DELIMITER ',', HEADER TRUE);

UPDATE zoning.codes_dictionary_plu SET HS = case when HS = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET HT = case when HT = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET HM = case when HM = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET of = case when of = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET HO = case when HO = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET SC = case when SC = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET IL = case when IL = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET IW = case when IW = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET IH = case when IH = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET RS = case when RS = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET RB = case when RB = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET MR = case when MR = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET MT = case when MT = 'x' then 'TRUE' else 'FALSE' end;
UPDATE zoning.codes_dictionary_plu SET ME = case when ME = 'x' then 'TRUE' else 'FALSE' end;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HS TYPE BOOLEAN USING HS::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HT TYPE BOOLEAN USING HT::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HM TYPE BOOLEAN USING HM::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN of TYPE BOOLEAN USING of::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HO TYPE BOOLEAN USING HO::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN SC TYPE BOOLEAN USING SC::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IL TYPE BOOLEAN USING IL::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IW TYPE BOOLEAN USING IW::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IH TYPE BOOLEAN USING IH::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN RS TYPE BOOLEAN USING RS::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN RB TYPE BOOLEAN USING RB::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN MR TYPE BOOLEAN USING MR::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN MT TYPE BOOLEAN USING MT::BOOLEAN;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN ME TYPE BOOLEAN USING ME::BOOLEAN;

ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HS TYPE INTEGER USING HS::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HT TYPE INTEGER USING HT::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HM TYPE INTEGER USING HM::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN of TYPE INTEGER USING of::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN HO TYPE INTEGER USING HO::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN SC TYPE INTEGER USING SC::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IL TYPE INTEGER USING IL::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IW TYPE INTEGER USING IW::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN IH TYPE INTEGER USING IH::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN RS TYPE INTEGER USING RS::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN RB TYPE INTEGER USING RB::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN MR TYPE INTEGER USING MR::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN MT TYPE INTEGER USING MT::INTEGER;
ALTER TABLE zoning.codes_dictionary_plu ALTER COLUMN ME TYPE INTEGER USING ME::INTEGER;
