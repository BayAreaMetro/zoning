...
# output/parcels_zoning.csv: 
# 	sudo -u postgres psql -f source_intersection_zoning.sql
...
#BRJmzqUZpQwKiIeBaTELi4XmdwS6jzzL
...
data_source/codes_base.back: s3-curl/s3curl.pl
	perl s3-curl/s3curl.pl --id=company \
	-- http://landuse.s3.amazonaws.com/zoning/codes_base.back -o data_source/codes_base.back 
